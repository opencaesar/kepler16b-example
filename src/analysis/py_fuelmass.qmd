...
analysisRocket = analysisOrbit.hohmanTransfer(orbit_init=400, orbit_target=35786, m_init=1000 * u.kg, I_sp=350 * u.s)
total_delta_v = analysisRocket.calculate_delta_v()
analysisRocket.calculate_fuel_mass()
analysisRocket.m_init
analysisRocket.m_final

print(f"Total delta-v: {total_delta_v}")
print(f"Required fuel mass: {analysisRocket.m_fuel.to(u.kg)}\n final: {analysisRocket.m_final.to(u.kg)}\n init: {analysisRocket.m_init.to(u.kg)}")
